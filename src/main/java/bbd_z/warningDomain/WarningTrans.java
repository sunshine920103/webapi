 ...
 */
public class WarningTrans {

    public String getParms(String fieldtype,String json){
    ...
    private String getHKDZ(Map<String,Object> map) {
        ...
        return JsonUtils.toJsonWithoutPretty(map);
    }

    private String getSWRY(Map<String, Object> map) {
    ...
    private String getGNLKXX(Map<String, Object> map) {
    ...
    private String getBPCRYXX(Map<String, Object> map) {
    ...
    private String getLKSMDP(Map<String, Object> map) {
    ...
    private String getJZRYHCSJ(Map<String, Object> map) {
    ...
    private String getTL(Map<String, Object> map) {
    ...
    private String getKY(Map<String, Object> map) {
        map.put("票号",map.remove("field1"));
        map.put("性别",map.remove("field2"));
        map.put("民族",map.remove("field3"));
        map.put("出生日期",map.remove("field4"));
    ...
    private String getLG(Map<String, Object> map) {
        map.put("性别",map.remove("field1"));
    ...
    private String getMH(Map<String, Object> map) {
